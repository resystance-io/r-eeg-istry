...
class VIEW_MANAGEMENT_REGISTRATIONS extends VIEW
{
    ...
    function view_render_registration($registration_id)
    {
        ...
        if ($registration['banking_consent'] != null)     $banking_consent_nice = date("d.m.Y H:i:s", $registration['banking_consent']);     else $banking_consent_nice = "&nbsp;";
        print "<tr class=\"stategray\"><td class=\"detailheader\">Einzugserm&auml;chtigung erteilt:</td><td class=\"detailcontent\">" . $banking_consent_nice . "</td></tr>";
