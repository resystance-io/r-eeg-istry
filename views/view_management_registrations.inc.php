...
class VIEW_MANAGEMENT_REGISTRATIONS extends VIEW
{
    ...
    function view_render_registration($registration_id)
    {
        ...
        print '<h3>Status</h3>';
        print "<table>";
        print "<tr><td class=\"profileheader\">EEG / Mandant:</td>";
        print "<td>" . $tenant_info['fullname'] . "</td>";
        print "</tr>";
        ...
        print "<table>";
        print "<tr><td class=\"profileheader\">Umspannwerk:</td>";
        print "<td>&nbsp;</td>";
        print "</tr>";
        print "<tr><td class=\"profileheader\">Anmeldenummer:</td>";
        print "<td>&nbsp;</td>";
        print "</tr>";
        print "<tr><td class=\"profileheader\">Mitgliedsnummer:</td>";
        print "<td>&nbsp;</td>";
        print "</tr>";
        print "<tr><td class=\"profileheader\">Status:</td>";
        print "<td>&nbsp;</td>";
        print "</tr>";
        print "<tr><td class=\"profileheader\">Letzte &Auml;nderung:</td>";
        print "<td>&nbsp;</td>";
        print "</tr>";
        print "</table>";
        print '<br />&nbsp;<br />';
